...
import JPADAO.productosJpaController;
...
public class MostrarProductos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            //Creamos un objeto que nos ayude a manejar la BD
            productosJpaController PJC = new productosJpaController(emf);
            //Devolvemos una lista con todos los productos para mostrarlos en la vista
            List<productos> listaP = PJC.findproductosEntities();
            
            //Mandamos la lista a la pagina de la tienda para mostrarlo
